...
Diagrama de Flujo (Google AI Studio): https://aistudio.google.com/apps/drive/1L8XZoyfbbxSvONb7N-XTtxxjGgoT2-n-?fullscreenApplet=true&showPreview=true&showAssistant=true
Notion: https://www.notion.so/2de3e5f795e680589bf3fa9e40f84cc3?v=2de3e5f795e680ea9d1b000ce5a0d8ab&source=copy_link


Guia de errores durante instalacion:
...
"Nota crítica: Es obligatorio ejecutar chmod +x pull-llama.sh antes de levantar el stack.
